define(["dojo/_base/kernel", "dojo/_base/lang", "dojo/_base/array","dojo/_base/Color", "gfx/_base","gfx/svg","gfx/matrix"],
  function(kernel, lang, arr, Color, g, svg, Matrix){

	kernel.experimental("gfx.svg_attach");
